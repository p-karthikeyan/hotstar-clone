...
const Slider = () => {
  ...
  const Movies = movieList.map(item=>{
    return <img src={ImageBaseUrl+item.backdrop_path} className='hover:border-4 border-gray-300 transition-all duration-200 ease-in-out min-w-full md:h-[400px] mr-5 rounded-lg object-cover object-left-top' alt="movie"/>
  })
